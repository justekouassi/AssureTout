						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="font-weight-bold text-primary text-uppercase mb-1 text-xs">
									<a href="/redacteur/sinistres" style="color: unset; text-decoration: none">
										Sinistres
									</a>
								</div>
						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="font-weight-bold text-warning text-uppercase mb-1 text-xs">
									<a href="/redacteur/experts" style="color: unset; text-decoration: none">
										Experts
									</a>
								</div>
								<div class="h5 font-weight-bold mb-0 text-gray-800">{{ $experts->count() }}</div>
							</div>
							<div class="col-auto">
								<i class="fas fa-calendar fa-2x text-gray-300"></i>
							</div>
						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="font-weight-bold text-success text-uppercase mb-1 text-xs">
									<a href="/redacteur/contrats" style="color: unset; text-decoration: none">
										Contrats
									</a>
								</div>
								<div class="h5 font-weight-bold mb-0 text-gray-800">{{ $contrats->count() }}</div>
							</div>
							<div class="col-auto">
						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="font-weight-bold text-danger text-uppercase mb-1 text-xs">
									<a href="/redacteur/courriers" style="color: unset; text-decoration: none">
										Courriers
									</a>
								</div>
								<div class="h5 font-weight-bold mb-0 text-gray-800">{{ $courriers->count() }}</div>
							</div>
							<div class="col-auto">
								<i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
							</div>

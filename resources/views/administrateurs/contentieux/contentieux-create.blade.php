...
@section('title', 'Création d\'un membre du service contentieux')
...
@section('content')
	...
	<div class="container-fluid">
		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h1 class="h3 mb-0 text-gray-800">Création d'un membre du service contentieux</h1>
		</div>
		<form class="form" method="POST" action="/admin/contentieux/create">
			@csrf

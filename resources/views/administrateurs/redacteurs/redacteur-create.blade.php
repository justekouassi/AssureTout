...
@section('title', 'Création d\'un rédacteur')
...
@section('content')
	...
	<div class="container-fluid">
		<div class="d-sm-flex align-items-center justify-content-center mb-4">
			<h1 class="h3 mb-0 text-gray-800">Création d'un rédacteur</h1>
		</div>
		<form class="form" method="POST" action="/admin/redacteurs/create">
			@csrf

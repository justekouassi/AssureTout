							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 mb-4 text-gray-900">Bienvenue</h1>
									</div>
									<form class="user">
										<div class="form-group">
											<input class="form-control form-control-user" id="exampleInputEmail" type="email"
										...
										<a class="btn btn-primary btn-user btn-block" href="index.html">
											Se connecter
										</a>
									</form>
									<hr>

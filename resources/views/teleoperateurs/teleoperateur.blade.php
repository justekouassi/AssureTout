						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="font-weight-bold text-primary text-uppercase mb-1 text-xs">
									<a href="/teleoperateur/clients" style="color: unset; text-decoration: none">
										Clients
									</a>
								</div>
								<div class="h5 font-weight-bold mb-0 text-gray-800">{{ $clients->count() }}</div>
							</div>
							<div class="col-auto">
						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="font-weight-bold text-warning text-uppercase mb-1 text-xs">
									<a href="/teleoperateur/offres" style="color: unset; text-decoration: none">
										Offres
									</a>
								</div>
